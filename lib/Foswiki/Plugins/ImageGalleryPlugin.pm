...
sub initPlugin {
  ...
  Foswiki::Plugins::JQueryPlugin::registerPlugin('ImageGallery', 'Foswiki::Plugins::ImageGalleryPlugin::Gallery');

  Foswiki::Plugins::RenderPlugin::registerAllowedTag("IMAGEGALLERY");
